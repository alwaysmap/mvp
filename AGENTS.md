...
- Write implementation plans for each major chunk of work before starting to code.
  ...
  For work that you're about to attempt, create or update a docs/NEXT_STEPS.md document.
  As you complete work, shift the actual vs. planned summary into a `docs/PHASE_X_PLAN.md`.
  This leaves a helpful record or what has been completed, how designs changes, and what key decisions were made.
- For major architectural decisions, create an architectural decision record (ADR) in /docs and link it into a plan.
